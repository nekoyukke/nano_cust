...
BUILTIN_FUNCTIONS: dict[str, tuple[types.Type, list[types.Type]]] = {
    ...
    "Random": (types.NumberType(), [types.NumberType(), types.NumberType()]),
    "Join": (types.StringType(), [types.StringType(), types.StringType()]),
    "LetterOf": (types.StringType(), [types.NumberType(), types.StringType()]),
    "TextLength": (types.NumberType(), [types.StringType()]),
    "Contains": (types.BooleanType(), [types.StringType(), types.StringType()]),
    "Round": (types.NumberType(), [types.NumberType()]),
    "Abs": (types.NumberType(), [types.NumberType()]),
    "Floor": (types.NumberType(), [types.NumberType()]),
    "Ceil": (types.NumberType(), [types.NumberType()]),
    "Sqrt": (types.NumberType(), [types.NumberType()]),
    "Sin": (types.NumberType(), [types.NumberType()]),
    "Cos": (types.NumberType(), [types.NumberType()]),
    "Tan": (types.NumberType(), [types.NumberType()]),
    "Asin": (types.NumberType(), [types.NumberType()]),
    "Acos": (types.NumberType(), [types.NumberType()]),
    "Atan": (types.NumberType(), [types.NumberType()]),
    "Ln": (types.NumberType(), [types.NumberType()]),
